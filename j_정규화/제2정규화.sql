...
#  	EX) 기본키가 (A, B)일 때, D는 A만으로 결정된다면 >> 부분 종속 >> 2NF에 위반
...
create table employees (
    ...
    departmemt_id varchar(50),	-- 직원이 솏한 부서
...
values
	('HR', 'seoul', 's1'),
	('SALES', 'busan', 's1'); -- location과 supervisor_id 속성이 기본 키에 완전 종속
...
create table wrong_2nf (
    ...
    location varchar(50), -- 부서 위치 (문제 발생!, 2NF 위반: department만으로 결정!)
